...
1.  在 Android Studio 中按照教程 [创建一个新的模块](https://developer.android.google.cn/studio/projects/add-app-module.html)。
...
1.  在您的应用模块中安装 [Firebase Android SDK](https://firebase.google.cn/docs/android/setup)。
...
3. 在您应用的 `build.gradle`  文件中添加 Firebase 实时数据库和 Firebase 可视化界面依赖：
