...
1.  在您的工程中安装 [Firebase Android SDK](https://firebase.google.cn/docs/android/setup) 
...
2. 在 [Firebase 控制台](https://firebase.google.cn/console/) 选择 Import Google Project 来将您为 Cloud Vision 创建的 Google Cloud 工程导入 Firebase 中。
...
4. 在您应用的 `build.gradle` 文件中添加  Firebase 实时数据库依赖：
...
2.  点击 **Rules** ，然后更新数据库规则，让所有人拥有读写权限：
...
1.  在 [Firebase 控制台](https://firebase.google.cn/console/)，在您工程中，点击 **Database**。
