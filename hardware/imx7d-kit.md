...
![inventory](../images/imx7d-kit/inventory.jpg)
...
![Bubble_number_02](../images/common/bubble-numbers/Bubble_number_02.png)
...
![Bubble_number_06](../images/common/bubble-numbers/Bubble_number_06.png)
...
![Bubble_number_08](../images/common/bubble-numbers/Bubble_number_08.png)
...
![antenna_step1](../images/imx7d-kit/antenna_step1.jpg)
...
![antenna_step2](../images/imx7d-kit/antenna_step2.jpg)
...
![camera_step1](../images/imx7d-kit/camera_step1.jpg)
...
![camera_step2](../images/imx7d-kit/camera_step2.jpg)
...
![hat_step1](../images/imx7d-kit/hat_step1.jpg)
...
![hat_step2](../images/imx7d-kit/hat_step2.jpg)
...
![hat_step3](../images/imx7d-kit/hat_step3.jpg)
...
![hat_step4](../images/imx7d-kit/hat_step4.jpg)
...
![display_step1](../images/imx7d-kit/display_step1.jpg)
...
![display_step2](../images/imx7d-kit/display_step2.jpg)
...
![display_step3](../images/imx7d-kit/display_step3.jpg)
...
![display_step4](../images/imx7d-kit/display_step4.jpg)
...
![final_result](../images/imx7d-kit/final_result.jpg)
...
Follow the hardware setup [instructions](../hardware/imx7d.html) to flash the latest version of Android Things on your i.MX7D development board.

## 安装 Android Things

* * *

按照硬件设定 [教程](../hardware/imx7d.html) 烧写最新版本的 Android Things 程序到您的 i.MX7D 开发板中。
...
如果您有一块彩虹外接调试板，按照以下步骤写入并启动一个[例子程序](https://github.com/androidthings/sample-button/) 该例子可以点亮调试板上的一个LED灯。 如果您没有彩虹外接调试板，您可以参考例子[连接LED和按钮](../training/first-device/connect-hardware.html) 来开发调试此例子程序。
...
*   Try one of the [other code samples](../sdk/samples.html). Remember to uninstall any existing samples from the development board before installing a new one, so that one does not interfere with the other. For example, to uninstall the previous samples from the command line:

        adb uninstall com.example.androidthings.button

*   Take a look at the [Peripherals codelab](https://codelabs.developers.google.com/codelabs/androidthings-peripherals) or learn how to [build your first device](../training/first-device/index.html).
...
*   试试 [其他例程](../sdk/samples.html). 请注意记得先卸载并删除开发板上已经安装的例子程序，然后在安装新的例子程序，以防止程序间互相干扰。比如，可以通过类似下面的命令行卸载已经安装的程序:

        adb uninstall com.example.androidthings.button

*   查看一下 [外接设备代码库](https://codelabs.developers.google.com/codelabs/androidthings-peripherals) 或者 学习一下如何 [开发您的第一款设备](../training/first-device/index.html).
